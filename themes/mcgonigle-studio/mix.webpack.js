const basePath = '/home/dev/public_html/project-winter';
...
module.exports = async () => {
    ...
    mix.listen('init', function (mix) {
        ...
        mix._api.alias({
            '$': '/home/dev/public_html/project-winter/plugins',
            '~': '/home/dev/public_html/project-winter',
        });
    ...
    require('/home/dev/public_html/project-winter/themes/mcgonigle-studio/winter.mix.js');
